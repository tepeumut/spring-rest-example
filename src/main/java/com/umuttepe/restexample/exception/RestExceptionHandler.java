package com.umuttepe.restexample.exception;

import com.umuttepe.restexample.exception.api.Error;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleEntityNotFound(javax.persistence.EntityNotFoundException ex) {
        return buildResponseEntity(new Error(HttpStatus.NOT_FOUND, ex));
    }
    ...
    protected ResponseEntity<Object> handleUserNotFound(UserNotFoundException ex) {
        return buildResponseEntity(new Error(NOT_FOUND, ex.getMessage(), ex));
    }
